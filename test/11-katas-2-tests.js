...
describe("11-katas-2-tasks", function () {
  it.optional(
    "parseBankAccount should return the bank account number from the specified string",
    () => {
      [
        {
          text:
  ...
  it.optional(
    "wrapText should return the sequence of lines from the specified string",
    () => {
      const text =
  ...
  it.optional(
    "getPokerHandRank should return the rank of the specified poker hand",
    () => {
      var rankNames = [];
      ...
      [
        ...
        assert(
          ...
          `'${data.hand}' is ranked as ${
            rankNames[data.expected]
          }, but actually ${rankNames[actual]} `
        );
      });
    }
  );
  ...
  it.optional(
    "getFigureRectangles should return the sequence of rectagles parts of the specified figure",
    () => {
      [
        {
          figure:
  ...
  var paths = ["task/11-katas-2-tasks.js"];
